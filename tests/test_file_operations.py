...
class TestSafeFilepath:
    ...
    def test_normal_relative_path(self, tmp_workspace):
        from app.tools.file_operations import _get_safe_filepath
...
class TestASTOutline:
    ...
    def test_small_file_returns_content(self, tmp_workspace):
        from app.tools.file_operations import read_file
    ...
    def test_read_function_extraction(self, tmp_workspace):
        from app.tools.file_operations import read_function
        src = textwrap.dedent(
            '''
            def hello(name):
                return f"hi {name}"
    ...
    def test_read_class_extraction(self, tmp_workspace):
        from app.tools.file_operations import read_class
        src = textwrap.dedent(
            """
            class MyClass:
                def method(self):
    ...
    def test_read_file_range(self, tmp_workspace):
        from app.tools.file_operations import read_file_range
...
class TestEditFile:
    ...
    def _edit(self, tmp_workspace, filename, search_block, replace_block):
        from app.tools.file_operations import edit_file
...
class TestBackupRollback:
    ...
    def test_backup_creates_file(self, tmp_workspace):
        from app.tools.file_operations import backup_file
    ...
    def test_rollback_restores(self, tmp_workspace):
        from app.tools.file_operations import backup_file, rollback_file
    ...
    def test_write_file_creates_dirs(self, tmp_workspace):
        from app.tools.file_operations import write_file
...
class TestListDirectory:
    def test_lists_files(self, tmp_workspace):
        from app.tools.file_operations import list_directory
