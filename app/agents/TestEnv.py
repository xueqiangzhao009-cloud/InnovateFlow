...
from app.core.settings import WORKSPACE_DIR, SANDBOX_IMAGE, SANDBOX_MEM_LIMIT, SANDBOX_CONTAINER_STARTUP_TIMEOUT, FUZZY_MATCH_THRESHOLD
...
def sandbox_node(state: AgentState):
    ...
    from app.core.quality_analyzer import analyze_code_quality, generate_code_quality_report
